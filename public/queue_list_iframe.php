...
<body >
<div class="card" style="margin-top:20px; margin-bottom: 10px; margin-left: 20px; margin-right: 20px; background-color:#E8E8E8; border: 0px; ">
<div class="card-body">
<div class="row">
<div class="col">รายชื่อผู้ป่วยรอรับยา RX queue</div>
<div class="col-sm-auto">
	<div class="btn-group btn-group-toggle" data-toggle="buttons">
  <label class="btn btn-secondary active" onclick="loadlink2('queue_list.php','1');indicator_show();clearhn();">
    <input type="radio" id="q_1" name="payment" value="1" autocomplete="off" <?php if (!(strcmp($_GET['pay'],"1"))) {echo "checked=\"checked\"";} ?> checked> ยังไม่ได้รับยา
  </label>
  <label class="btn btn-secondary" onclick="loadlink2('queue_list.php','2');indicator_show();clearhn();">
    <input type="radio" id="q_2" name="payment" value="2" autocomplete="off" > รับยาแล้ว
  </label>
  <label class="btn btn-secondary" onclick="loadlink2('queue_list.php','3');indicator_show();clearhn();">
    <input type="radio" id="q_3" name="payment" value="3" autocomplete="off" > ไม่มารับยา
  </label>
	</div>
</div>
<div class="col">
    <input name="hn2" type="text" class="thfont font14 inputcss1" id="hn2" value="<?php echo $_GET['hn']; ?>" style="height: 35px;" />&ensp;<span class="btn btn-primary" style="cursor: pointer" onclick="searchhn('queue_list.php');indicator_show();" >ค้นหา</span>
</div>
</div>
</div>
</div>
<div id="rx_queue" style=" margin-left: 20px; margin-right: 20px;"></div>
