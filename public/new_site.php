    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
      ...
      <script>
          ...
          function ajax_link(url){
                $('#indicator').show();
                $("#result").load(url, function(responseTxt, statusTxt, xhr){
...
<body>
  <div class="sidebar close" >
    <div class="logo-details" style="background: #324066">
		<i class="fab fa-maxcdn text-white"></i>
		<span class="logo_name">MahaHealth</span>
    </div>
    <ul class="nav-links">
      <li>
        <a href="#" onClick="ajax_link('report_dashboard.php');" >
      ...
      <li>
        ...
        <ul class="sub-menu">
          ...
          <li><a href="#" onClick="ajax_link('report_covid.php');" >ผู้ป่วย Covid-19</a></li>
        </ul>
      </li>
      <li>
        <div class="iocn-link">
    ...
    <div class="profile-details">
      <div class="profile-content">
        <img src="include/sidebar/image/profile.jpg" alt="profileImg">
      </div>
      <div class="name-job">
