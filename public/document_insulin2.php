...
<head>
<meta charset="utf-8">
<title>ใบแนะนำการฉีดอินซฺลินแบบไซริงค์</title>
...
<div class="page thfont">
    <div class="subpage">
        ...
        <div class="text-center font20 font-weight-bold mt-5">ใบแนะนำการฉีดอินซูลินแบบไซริงค์</div>    
        <div class="text-center font18 mt-3"><strong>ชื่อ</strong>&nbsp;<?php echo ptname($hn); ?>&ensp;<strong>HN</strong>&nbsp;<?php echo $hn; ?></div> 
            <div class="card mt-3 border-dark">
            <div class="card-header bg-dark text-white font16 font-weight-bold"><span class="badge badge-light font16">1</span>&ensp;เข็มที่ใช้</div>
                <div class="card-body p-1">
                    <div >
                            <div class="card border-0"><div class="card-body font18 p-0" align="center">
                                <div align="center" ><img src="images/syring_insulin.jpg" width="547" height="99" alt=""/></div>
                              ไซริงค์ (Syring)</div></div>
        ...
        <div class="mt-2">
            <div class="card border-dark">
                ...
                <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                <div class="font-weight-bold mt-2 " style="font-size: 30px"><i class="fas fa-sun btn btn-warning" style="font-size: 30px">&nbsp;เช้า</i>&ensp;ฉีด..........................ยูนิต  / ดูดยา.................ขีด</div>
                                <div class="font-weight-bold mt-3" style="font-size: 30px"><i class="fas fa-moon font20 btn btn-info" style="font-size: 30px">&nbsp;เย็น</i>&ensp;ฉีด..........................ยูนิต  / ดูดยา.................ขีด</div>
                            </div>
                        </div>
                            
                        <div class="row mt-2">
                            <div class="col-12">
                            <div style="border: dotted 1px #676565;" class="font20 col rounded p-2 mr-2 pt-2 text-center bg-light font-weight-bold">
