...
$query_channel1 = "SELECT channel_name,room_id from ".$database_kohrx.".kohrx_queue_caller_channel q left outer join ".$database_kohrx.".kohrx_queue_caller_channel_name n on n.id=q.channel WHERE ip='$get_ip'";
...
mysql_select_db($database_hos, $hos);
$query_rs_vdo = "select * from ".$database_kohrx.".kohrx_dispensing_setting where name ='VDO_display'";
...
mysql_select_db($database_hos, $hos);
$query_rs_advertise = "select * from ".$database_kohrx.".kohrx_queue_caller_advertise where CURDATE() between start_date and end_date";
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="92" colspan="2" align="center" valign="bottom" bgcolor="#292929"  class="gray2" style="font-size:36px; font-weight:bolder; color:#FFFF00; padding:5px; border:solid 0px"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="80%" align="right"><span  style="font-size:36px; font-weight:bolder; color:#FFFF00; padding:5px; border:solid 0px"><img src="images/55.png" width="78" height="78">&nbsp; กลุ่มงานเทคนิคการแพทย์ <?php echo $row_rs_config['hospitalname']; ?>
...
<ul style="margin:0px; alignment-adjust:central; text-align: center">
    ...
    <tr>
      <td width="52%" height="406" align="center" valign="top" bgcolor="#292929" ><div id="indicator"  align="center" style="position:absolute; display:none; z-index:1000;padding:0px;"> <img src="images/indicator.gif" hspace="10" align="absmiddle" width="0px" height="0px" />&nbsp;</div><div id="displayDiv" class="displayIndiv" >&nbsp;</div>
</td>
      <td width="48%" align="center" valign="top" class="gray2"><table width="100%" border="0" cellspacing="0" cellpadding="0" height="860">
       
        <tr>
          <td height="300" bgcolor="#333333"><img src="images/lab_process.gif" width="915" height="300"></td>
        </tr>
        <tr>
