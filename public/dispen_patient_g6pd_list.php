...
mysql_select_db($database_hos, $hos);
$query_rs_patient = "select r.*,concat(p.pname,p.fname,' ',p.lname) as ptname from ".$database_kohrx.".kohrx_patient_g6pd r left outer join patient p on p.hn=r.hn where record_date between '".$_GET['datestart']."' and '".$_GET['dateend']."' ".$condition." order by r.record_date ASC";
...
<title>รายชื่อผู้ป่วย G6PD</title>
