...
<?php
		...
		$query_rs_med = "select m.*,a.dx_doctor,v.age_y,v.age_m,o.bw,v.pdx,a.an from ".$database_kohrx.".kohrx_med_reconcile m left outer join vn_stat v on v.hn=m.hn and v.vstdate=m.vstdate2 left outer join opdscreen o on o.vn=v.vn left outer join an_stat a on a.vn=v.vn where m.hn='".$_GET['hn']."' and m.vstdate2='".$_GET['vstdate']."' order by drug_name ";
...
<span class="font-weight-bold">Dx แรกรับ/โรคประจำตัว</span>&ensp;<span class="font12"><?php echo diag($pdx); ?></span><br>
    ...
    <tr style="height: 40px;">
      <td class="thfont" style="padding-left: 5px; font-size: 13px; vertical-align: top;">
        ...
        <div class="pl-4" style="margin-top: -5px; font-size: 10px"><?php echo "- ".mb_substr($row_rs_med2['drugusage'],0,100,'UTF-8'); ?></div>
